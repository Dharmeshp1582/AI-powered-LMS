...
const Home = () => {
  return (
    ...
    <button className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black text-[18px] rounded-[10px] font-light flex gap-2 cursor-pointer'>View all courses <SiViaplay className='w-[30px] h-[30px] lg:fill-white fill-black ' /></button>
