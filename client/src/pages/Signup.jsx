...
const Signup = () => {
  ...
  return (
    ...
    <input type="text" id='name' placeholder='Your name' className='border-1 w-[100%] h-[35px] border-[#e7e6e6] text-[15px] px-[20px] '/>
        </div>
    ...
    <IoEyeOutline onClick={() => setShow(!show)} className='absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]'/>
       ...
       <span className='px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl hover:border-black cursor-pointer '>Student</span>
       <span className='px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl hover:border-black cursor-pointer'>Educator</span>
        </div>
