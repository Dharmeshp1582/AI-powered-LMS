...
import watch from '../assets/watching.mp4'
...
{/* For image area */}
     <div className='lg:w-[40%] md:w-[80%] w-[100%] h-[100%] flex items-center justify-center relative '>
      ...
      <video src={watch} autoPlay loop controls  className='w-full rounded-xl shadow-lg border-2 border-white'></video>
      </div>
     </div>
  ...
  <div className='flex items-center justify-between mt-[40px]'>
    ...
    <div className='flex items-center justify-center gap-[10px]'>
        <BsFillPatchCheckFill className='w-[20px] h-[20px] ' /> Expert Trainers
...
<div className='flex items-center justify-between mt-[40px]'>
    <div className='flex items-center justify-center gap-[10px]'>
        <BsFillPatchCheckFill className='w-[20px] h-[20px] ' /> With High experience 
